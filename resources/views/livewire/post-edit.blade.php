<form wire:submit.prevent="submitForm" action="#" method="POST" enctype="multipart/form-data">
    ...
    <div>
        <div>
            <div>
                <a href="/posts" class="text-blue-600">Back to posts</a>
            ...
            <div class="mt-6 sm:mt-5">
                ...
                <div
                    ...
                    <div 
                        ...
                        <div>
                            <svg wire:loading wire:target="photo" class="animate-spin -ml-1 mr-3 h-5 w-5 text-gray-600" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24">
